...
:doc:`lists`, :doc:`tuples`, :doc:`dicts` and :doc:`files`. These data types can
be manipulated using language operators, built-in functions, library functions
or a data type’s own methods.
